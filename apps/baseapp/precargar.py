...
def cargaInicial():
    ...
    listaBancos = list()
    for i in bancosColombia:
        listaBancos.append(Banco(
            nombre = i
        ))
    Banco.objects.bulk_create(listaBancos)

    # Precargar formas de pago
    formasdepago=[
        "contado",
        "Credito",
        "Credito-08",
    ...
    listaFormasdePago = list()
    for i in formasdepago:
        listaFormasdePago.append(FormaPago(
            nombre = i
        ))
    ...
    listaEstadoVenta = list()
    for i in estadoVenta:
        listaEstadoVenta.append(EstadoVenta(
            nombre = i
        ))
    ...
    listaEstadoCompra = list()
    for i in estadoCompra:
        listaEstadoCompra.append(EstadoCompra(
            nombre = i
        ))
    ...
    listaEstadoProducto = list()
    for i in estadosproducto:
        listaEstadoProducto.append(EstadoProducto(
            nombre = i
        ))
    EstadoProducto.objects.bulk_create(listaEstadoProducto)
    #************* cierra Precargar estado de producto ******************
    ...
    Departamento.objects.bulk_create(listaDepartamentos)
    ...
    for key in ciu:
        ...
        listaCiudades.append(Ciudad(        
            cod_dane = key,
            nombre = ciu[key],
            departamento = Departamento.objects.get(cod_dane = dep)
        ))  
    Ciudad.objects.bulk_create(listaCiudades)
    ...
    listaDocum = list()
    for key in docum:
        listaDocum.append(TipoDocumento(
            cod = key,
            nombre = docum[key],
        ))  
    TipoDocumento.objects.bulk_create(listaDocum)
    
    
   # precargar menu
    grupomenu=[
        ["1","Favoritos", "fa fa-star"],
        ["2", "Formularios", "fa fa-plus-square"],
        ["3", "Ventas", "fa fa-bell"],
        ["4", "Compras", "fa fa-shopping-bag"],
        ["5", "Inventarios", "fa fa-stack-overflow"],
        ["6", "Reportes", "fa fa-file-text-o"],
        ["7", "ajustes", "fa fa-wrench"],
    ]
    listaGrupoMenu = list()
    for i in grupomenu:
        listaGrupoMenu.append(Menu(
            id = i[0],
            nombre = i[1],
            orden = i[0]
        ))
    Menu.objects.bulk_create(listaGrupoMenu)
    

    # precargar Submenu
    grupoSubmenu=[        
        [1, "1", "Productos", "fa fa-microchip", "/productos", False],
        [2, "3", "Clientes", "fa fa-address-book-o", "#", False],
        [2, "4", "Proveedores", "fa fa-handshake-o", "#", False],
        [2, "5", "Bancos", "fa fa-university", "/bancos", False],
        [2, "8", "Categorias", "fa fa-object-group", "/categorias", False],
        [2, "9", "Sub Categoria", "fa fa-object-ungroup", "/subcategorias", False],
        [2, "10", "Departamentos", "fa fa-map", "/departamentos", False],
        [2, "11", "Ciudad", "fa fa-map-o", "/ciudades", False],
        [2, "12", "Tiposdocumento", "fa fa-id-card", "/tiposdocumento", False],
        [2, "13", "Estado del producto", "fa fa-check-square-o", "/estadosproducto", False],
        [2, "14", "Formaspago", "fa fa-paypal", "/formaspago", False],
        [2, "15", "Estado de la venta", "fa fa-check-circle-o", "/estadosventa", False],
        [3, "6", "Ver Ventas", "fa fa-eye-slash", "/ventas", False],
        [3, "7", "Crear", "fa fa-plus-square", "/guardarventa", False],

    ]

    listaGrupoSubMenu = list()
    for i in grupoSubmenu:
        listaGrupoSubMenu.append(SubMenu(
    ...
    SubMenu.objects.bulk_create(listaGrupoSubMenu)
